...
I have experience with Java, Python, Spring Boot, SQL, and full-stack web development. I am comfortable with backend development, APIs, databases, and debugging, and I want to improve my Python and open-source contribution skills. I prefer well-scoped issues that I can understand and complete within a few hours, especially documentation, testing, configuration, or small backend fixes.